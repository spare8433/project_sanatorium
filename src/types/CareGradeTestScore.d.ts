export interface PhysicalScoreObjType {
  /** 옷 벗고 입기 */
  cloth: number
  /** 세수하기 */
  washFace: number
...
export interface RecognScoreObjType {
  /** 단기 기억장애 */
...
export interface BehaviorScoreObjType {
  /** 망상 */
  delusion: number
  /** 환각, 환청 */
...
export interface NursingScoreObjType {
  /** 기관지 절개관 간호 */
...
export interface RehabExerciseScoreObjType {
  /** 우측상지 */
...
export interface RehabJointScoreObjType {
  /** 어깨관절 */
